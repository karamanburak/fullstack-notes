...
//! b- Birinci kullanicinin todo bilgisi ve yapipilip yapilmama durumunu listeleyin

// const filteredTodos = userTodos.filter((todo) => todo.id === 1);

// filteredTodos.forEach((filteredTodo) => {
//     console.log(filteredTodo.completed);
//     console.log(filteredTodo.title);
// });
...
//     .forEach((person) => console.log(person.title));
//^ V2
// userTodos
...
// const num = +prompt("Enter an Id (1-5): ")
// userTodos
//     .filter((todo) => todo.userId === num && todo.completed === true)
...
//! a- Ürün ve fiyatlari listelemek
//^ VERSION 1
// products.filter((temp) => console.log(`${temp.title} :${temp.price}`))
...
//     .forEach(({ title, price }) => console.log(`title: ${title}
//     price: ${price} 💶`))
...
// products =
// products.filter((category) => category.category !== "home-decoration")
// .forEach((product) => console.log(product))



//! e - Kullanicinin sectigi ürünü (id si girilen ürünü) silin

// let id = +prompt("Enter an id (1-30)")
...
//! Rest operatoru kullanarak fiyatlari indirimli fiyatlar ile güncelle - Update
...
//! - Her kategoride kac ürün var göster
...
console.log(countCategoryElements(products)); // {smartphones: 5, laptops: 5, fragrances: 5, skincare: 5, groceries: 5, …}
